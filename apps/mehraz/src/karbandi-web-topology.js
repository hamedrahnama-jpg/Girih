...
export function normalizeKarbandiWebOptions(value = {}) {
  ...
  return {
    ...
    wallBearingDepth: number(value.wallBearingDepth, 0.15, 0, 5),
    wallEmbedTolerance: number(value.wallEmbedTolerance, 0.005, 0, 0.1),
    ribEmbedTolerance: number(value.ribEmbedTolerance, 0.003, 0, 0.1),
